...
void function () {
  var assert, buildRequester, createAlertApi, createCookieApi, createDebugApi, createElementApi, createMouseApi, createNavigationApi, createPageApi, createSession, extend, http, parseResponseData, WebDriver;
  ...
  module.exports = WebDriver = function () {
    function WebDriver(serverUrl, desiredCapabilities, httpOptions) {
      ...
      extend(this, createMouseApi(this.http));
    }
